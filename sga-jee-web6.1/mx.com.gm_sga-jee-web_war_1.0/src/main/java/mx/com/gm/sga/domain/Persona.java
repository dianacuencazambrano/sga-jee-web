...
public class Persona implements Serializable {
    ...
    @JoinColumn(name = "id_gradoInstrucción", referencedColumnName = "id_gradoInstrucción", insertable=false, updatable=false)
    @ManyToOne
    private GradoIntruccion CgradoInstruccion;

    @Basic(optional = false)
    @Column(name = "id_gradoInstrucción")
    private Integer id_gradoInstrucción;    
    ...
    public Persona(Integer idPersona, String nombre, String apellidoPaterno, String apellidoMaterno, String email, String telefono, GradoIntruccion CgradoInstruccion) {
        this.idPersona = idPersona;
        this.nombre = nombre;
        this.apellidoPaterno = apellidoPaterno;
        this.apellidoMaterno = apellidoMaterno;
    ...
    public GradoIntruccion getCgradoInstruccion() {
        return CgradoInstruccion;
    }

    public void setCgradoInstruccion(GradoIntruccion CgradoInstruccion) {
        this.CgradoInstruccion = CgradoInstruccion;
    }

    public Integer getId_gradoInstrucción() {
        return id_gradoInstrucción;
    }

    public void setId_gradoInstrucción(Integer id_gradoInstrucción) {
        this.id_gradoInstrucción = id_gradoInstrucción;
    }
